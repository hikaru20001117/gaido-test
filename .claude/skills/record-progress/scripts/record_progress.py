...
FLOW_PHASES: dict[str, list[dict[str, str]]] = {
    ...
    "persona_generator": [
        {"phase": "開発内容選択フェーズ", "ui_phase": "welcome", "ui_phase_label": "開発内容選択"},
        {"phase": "基本情報入力フェーズ", "ui_phase": "persona_input", "ui_phase_label": "基本情報入力"},
        {"phase": "性格特性分析フェーズ", "ui_phase": "persona_analysis", "ui_phase_label": "性格特性分析"},
        {"phase": "判断基準フェーズ", "ui_phase": "persona_criteria", "ui_phase_label": "判断基準"},
        {"phase": "問いの軸フェーズ", "ui_phase": "persona_axes", "ui_phase_label": "問いの軸"},
        {"phase": "振る舞いルールフェーズ", "ui_phase": "persona_rules", "ui_phase_label": "振る舞いルール"},
        {"phase": "ペルソナ生成フェーズ", "ui_phase": "persona_generate", "ui_phase_label": "ペルソナ生成"},
        {"phase": "ペルソナ生成完了", "ui_phase": "persona_complete", "ui_phase_label": "完了"},
    ],
    "proposal": [
        {"phase": "開発内容選択フェーズ", "ui_phase": "welcome", "ui_phase_label": "開発内容選択"},
...
LEGACY_UI_PHASE_MAPPING: dict[str, dict] = {
    ...
    # persona_generator フロー
    "基本情報入力フェーズ": {"ui_phase": "persona_input", "ui_phase_number": 0, "ui_phase_label": "基本情報入力"},
    "性格特性分析フェーズ": {"ui_phase": "persona_analysis", "ui_phase_number": 0, "ui_phase_label": "性格特性分析"},
    "判断基準フェーズ": {"ui_phase": "persona_criteria", "ui_phase_number": 0, "ui_phase_label": "判断基準"},
    "問いの軸フェーズ": {"ui_phase": "persona_axes", "ui_phase_number": 0, "ui_phase_label": "問いの軸"},
    "振る舞いルールフェーズ": {"ui_phase": "persona_rules", "ui_phase_number": 0, "ui_phase_label": "振る舞いルール"},
    "ペルソナ生成フェーズ": {"ui_phase": "persona_generate", "ui_phase_number": 0, "ui_phase_label": "ペルソナ生成"},
    "ペルソナ生成完了": {"ui_phase": "persona_complete", "ui_phase_number": 0, "ui_phase_label": "完了"},
}
