...
| 13 | 既存ソース解析フェーズ | /existing-source-analysis-operations 実行前 | ソース解析 |
...
| 24 | 提案準備フェーズ | /gaido-proposal-init Step 0-1 開始前 | 準備 |
| 25 | 資料読み込みフェーズ | /gaido-proposal-init Step 3 開始前 | 資料読込 |
| 26 | 構成壁打ちフェーズ | /gaido-proposal-init Step 4 開始前 | 構成壁打ち |
| 27 | デザインフェーズ | /gaido-proposal-init Step 9 開始前 | デザイン |
| 28 | 図表・スライド生成フェーズ | /gaido-proposal-init Step 10 開始前 | スライド生成 |
| 29 | 提案書確認フェーズ | /gaido-proposal-init Step 11 確認前 | 確認 |
| 30 | 提案書完了 | /gaido-proposal-init 完了時 | 完了 |
| 31 | 基本情報入力フェーズ | /gaido-persona-generator Step 0 開始前 | 基本情報入力 |
| 32 | 性格特性分析フェーズ | /gaido-persona-generator Step 1 開始前 | 性格特性分析 |
| 33 | 判断基準フェーズ | /gaido-persona-generator Step 3 段階1 開始前 | 判断基準 |
| 34 | 問いの軸フェーズ | /gaido-persona-generator Step 3 段階2 開始前 | 問いの軸 |
| 35 | 振る舞いルールフェーズ | /gaido-persona-generator Step 3 段階3 開始前 | 振る舞いルール |
| 36 | ペルソナ生成フェーズ | /gaido-persona-generator Step 4 開始前 | ペルソナ生成 |
| 37 | ペルソナ生成完了 | /gaido-persona-generator 完了時 | 完了 |
