...
1. `.claude/skills/analyze/framework/framework.md` - フレームワーク定義
2. `.claude/skills/analyze/framework/story_format.md` - ストーリー形式
...
| エキスパート | 役割 | 参照 |
|-------------|------|------|
| **PO** | プロダクト価値最大化、バックログ管理 | [po.md](.claude/skills/personas/analyze/core/po.md) |
| **Architect** | 技術設計、構造決定、拡張性検証 | [architect.md](.claude/skills/personas/analyze/core/architect.md) |
| **QA** | 品質保証、テスト戦略、DoD主導 | [qa.md](.claude/skills/personas/analyze/core/qa.md) |
| **Security** | セキュリティ確保、リスク評価 | [security.md](.claude/skills/personas/analyze/core/security.md) |
...
| パターン | 参照 |
|----------|------|
| 新規開発 | [new_development.md](.claude/skills/analyze/patterns/new_development.md) |
| 保守 | [maintenance.md](.claude/skills/analyze/patterns/maintenance.md) |
| データパイプライン | [data_pipeline.md](.claude/skills/analyze/patterns/data_pipeline.md) |
...
1. **専門家の観点から確認**
   - 各専門家ファイル（[personas/analyze/core/](.claude/skills/personas/analyze/core/)）の「重視する観点」を参照
...
- **分析プロセス**: [framework.md](.claude/skills/analyze/framework/framework.md)
...
- **専門家の観点**: [personas/analyze/core/](.claude/skills/personas/analyze/core/) 配下の各ファイル
